                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[80vh] flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="overflow-y-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                            {PROJECTS.map(project => {
                                ...
                                const isDisabled = !hasPrereqs || (!canAfford && !isActive && !isCompleted);
                                ...
                                return (
                                    ...
                                    ${isCompleted ? 'border-green-200 bg-green-50' :
                                                isActive ? 'border-blue-200 bg-blue-50' :
                                                    !hasPrereqs ? 'border-gray-200 bg-gray-50 opacity-70 grayscale' :
                                ...
                                `}
                                    >
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            {!hasPrereqs && <div className="text-xs font-bold text-red-500 border border-red-200 px-2 py-1 rounded bg-red-50">Kilitli</div>}
                                        </div>
                                        ...
                                        `}
                                            >
                                                {hasPrereqs ? 'Projeyi Başlat' : 'Kilitli'}
                                            </button>
                                        )}
                                    </div>
                                );
